...
let blogName = "flaf.dev";
let authorName = "flag";
let authorLink = "https://flaf.dev/about"; // Enter your website, social media, etc. Some way for people to tell you they like your blog! (Leaving it empty is okay too)
...
<li><a href="${relativePath}/astro">astro</a></li>
<li><a href="${relativePath}/fox">fox</a></li>
...
if (currentIndex > -1) {
  ...
  if (postDateFormat.test(postsArray[currentIndex][0].slice(6, 17))) {
    ...
    niceDate = `${postsArray[currentIndex][0].slice(
      14,
      16
    )} ${month}, ${postsArray[currentIndex][0].slice(6, 10)}`;
  }
}
...
if (postsArray.length < 2) {
  ...
  nextprevHTML = `<a href="${relativePath}/${prevlink}">\u00AB previous post</a> | <a href="${relativePath}/">home</a>`;
} else if (currentIndex === postsArray.length - 1) {
  nextlink = postsArray[currentIndex - 1][0];
  nextprevHTML = `<a href="${relativePath}/">home</a> | <a href="${relativePath}/${nextlink}">next post \u00BB</a>`;
} else if (0 < currentIndex && currentIndex < postsArray.length - 1) {
  nextlink = postsArray[currentIndex - 1][0];
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = `<a href="${relativePath}/${prevlink}">\u00AB previous post</a> | <a href="${relativePath}/">home</a> | <a href="${relativePath}/${nextlink}">next post \u00BB</a>`;
}
...
if (document.title === "Blog Post") {
  document.title = `flaf.dev ~ ${currentPostTitle}`;
}
